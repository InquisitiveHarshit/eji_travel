          ...
          {itinerary.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className={`relative p-3 rounded-2xl transition-all duration-500 ${isOpen
                    ? "bg-white shadow-2xl ring-1 ring-slate-100"
                    : "hover:bg-white/50 shadow-[0px_1px_4px_rgba(255,140,0,0.6)]"
                  }`}
              >
                <div className="grid grid-cols-1 sm:grid-cols-[auto_1fr] gap-6">
                  ...
                  */}
                  <motion.div
                    layout
                    transition={{ duration: 0.5, ease: [0.4, 0, 0.2, 1] }}
                    className={`relative overflow-hidden flex-shrink-0 rounded-2xl shadow-md ${isOpen
                  ...
                  <div className="flex flex-col justify-center py-2 pr-4">
                    ...
                    <motion.p
                      layout
                      className={`text-slate-500 mt-2 leading-relaxed text-sm sm:text-base ${isOpen ? "" : "line-clamp-2"}`}
                    >
                      {item.description}
                    </motion.p>
                    ...
                    <motion.div
                      layout
                      className="flex gap-4 mt-2 text-slate-400"
                    >
